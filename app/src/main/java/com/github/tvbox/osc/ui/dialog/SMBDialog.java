...
public class SMBDialog extends BaseDialog {
    ...
    public SMBDialog(@NonNull @NotNull Context context, StorageDrive drive) {
        super(context);
        setContentView(R.layout.dialog_smb);
        if(drive != null)
            this.drive = drive;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnConfirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(SMBDialog.this.getContext(), "请赋予一个空间名称", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(url == null || url.length() == 0)
                {
                    Toast.makeText(SMBDialog.this.getContext(), "请务必填入SMB地址", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(drive != null) {
                    ...
                    RoomDataManger.insertDriveRecord(name, StorageDriveType.TYPE.SMB, config);
                }
